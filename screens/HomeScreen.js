      ...
      <View style={styles.card}>
        ...
        <View style={styles.ecoRow}>
          <View style={styles.ecoBox}>
            ...
            <Text style={styles.ecoValue}>12<Text style={styles.ecoUnit}>개</Text></Text>
          </View>
          <View style={styles.separator} />
          <View style={styles.ecoBox}>
            <Text style={styles.ecoLabel}>내 에코 점수</Text>
            <Text style={styles.ecoValue}>85<Text style={styles.ecoUnit}>점</Text></Text>
          </View>
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  ecoRow: {
    ...
    alignItems: 'center',
    backgroundColor: '#f8fdf9', // 연한 초록색 배경
    padding: 15,
    borderRadius: 12,
  },
  ecoBox: {
